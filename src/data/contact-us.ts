export const contactPage = {
  hero: {
    ...
    title: "Contact Us",
    summary:
      "Get in touch with us for any enquiries and question you want to know",
  },
  socials: [
    ...
    [
      {
        ...
        items: [
          { label: "info@examples.com", href: "mailto:info@examples.com" },
          { label: "+01234567839", href: "tel:+01234567839" },
        ],
      },
      {
        title: "Collaborations",
        items: [
          { label: "work@examples.com", href: "mailto:work@examples.com" },
          { label: "+012345678390", href: "tel:+012345678390" },
        ],
      },
    ],
    [
      {
        title: "Careers",
        items: [{ label: "hr@examples.com", href: "mailto:hr@examples.com" }],
      },
      {
        title: "Address",
        maxWidth: "205px",
        items: [
          {
            label: "256/F\u00a0Central Street, South City, N J, USA",
          },
        ],
      },
    ],
  ...
  video: {
    poster: "/videos/contact-us-video-poster-00001.jpg",
    mp4: "/videos/contact-us-video-transcode.mp4",
    webm: "/videos/contact-us-video-transcode.webm",
  },
  form: {
    title: "Send a Message",
    summary:
      "I have a great opportunity to work with talented people and\u00a0big company and have lots experience and gather skills.",
