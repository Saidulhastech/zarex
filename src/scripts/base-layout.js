  ...
  const initGsap = () => {
    ...
    gsapContext = gsap.context(() => {
      ...
      const createScrollTrigger = (vars) => {
        ...
        if (vars.onEnterBack)
          scrollTriggerConfig.onEnterBack = vars.onEnterBack;
        if (vars.onLeaveBack)
          scrollTriggerConfig.onLeaveBack = vars.onLeaveBack;
      ...
      withSection("[data-hero-v2]", (heroSection) => {
        ...
        const leftShape = heroSection.querySelector(
          "[data-hero-v2-left-shape]",
        );
        ...
        if (prefersReducedMotion) {
          if (eyebrow)
            gsap.set(eyebrow, { filter: "blur(0px)", yPercent: 0, opacity: 1 });
          if (title)
            gsap.set(title, { filter: "blur(0px)", yPercent: 0, opacity: 1 });
          if (summary)
            gsap.set(summary, { filter: "blur(0px)", yPercent: 0, opacity: 1 });
          if (buttonGroup)
            gsap.set(buttonGroup, {
              filter: "blur(0px)",
              yPercent: 0,
              opacity: 1,
            });
      ...
      withSection("[data-special-v2]", (specialSection) => {
        ...
        const carousel = specialSection.querySelector(
          "[data-special-v2-carousel]",
        );
        const viewport = specialSection.querySelector(
          "[data-special-v2-viewport]",
        );
        ...
        const prevButton = specialSection.querySelector(
          "[data-special-v2-prev]",
        );
        const nextButton = specialSection.querySelector(
          "[data-special-v2-next]",
        );
        ...
        const moveTo = (index, instant = false) => {
          ...
          const fadeDuration = instant
            ? 0
            : Math.min(0.35, transitionDuration * 0.5);
      ...
      withSection("[data-wcu-section]", (wcuSection) => {
        ...
        const wcuImages = [
          {
            element: wcuSection.querySelector(
      ...
      withSection("[data-about-section]", (aboutSection) => {
        ...
        badgeLoops.forEach(({ key, startY, rotation }) => {
          const badge = aboutSection.querySelector(
            `[data-about-badge="${key}"]`,
          );
          if (!badge) {
            return;
          }
      ...
      withSection("[data-about-intro]", (introSection) => {
        const heading = introSection.querySelector(
          "[data-about-intro-heading]",
        );
        const imageWrap = introSection.querySelector(
          "[data-about-intro-image]",
        );
        const funfactsWrap = introSection.querySelector(
          "[data-about-intro-funfacts]",
        );
        const cardsWrap = introSection.querySelector(
          "[data-about-intro-cards]",
        );
        const cards = Array.from(
      ...
      withSection("[data-history-section]", (historySection) => {
        ...
        const buttonWrap = historySection.querySelector(
          "[data-history-button]",
        );
        const buttonOverlay = buttonWrap?.querySelector(
          ".button-animation-overlay-v2",
      ...
      withSection("[data-about-wcu]", (wcuSection) => {
        ...
        const images = Array.from(
          wcuSection.querySelectorAll(
            "[data-about-wcu-images] .wcu-image-block",
          ),
        );
      ...
      withSection("[data-about-team]", (teamSection) => {
        ...
        const viewport = teamSection.querySelector(
          "[data-about-team-viewport]",
        );
        const track = teamSection.querySelector("[data-about-team-track]");
        let slides = Array.from(
          teamSection.querySelectorAll("[data-about-team-slide]"),
        );
      ...
      withSection("[data-faq-section]", (faqSection) => {
        ...
        const items = Array.from(
          faqSection.querySelectorAll("[data-faq-item]"),
        );
      ...
      withSection("[data-testimonials-v3]", (section) => {
        const headingBlock = section.querySelector(
          "[data-testimonials-v3-heading]",
        );
        const contentBlock = section.querySelector(
          "[data-testimonials-v3-content]",
        );
        const innerBlocks = Array.from(
          section.querySelectorAll("[data-testimonials-v3-track]"),
        );
      ...
      withSection("[data-impact-section]", (impactSection) => {
        ...
        const runCounter = (element) => {
          ...
          const rawValue =
            element.dataset.impactValue || element.textContent || "";
          const match = rawValue.match(/^([+-]?)(\d+(?:\.\d+)?)(.*)$/);
          if (!match) {
            return;
          }
